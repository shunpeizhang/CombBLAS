...
void make_graph(
  ...
  /* out */ int64_t** result         /* Array of edges (each std::pair of elements
                                      * is a single edge); std::pairs with first
 ...
 * users, and creates a std::vector of doubles in a reproducible (and
 * random-access) way. */
